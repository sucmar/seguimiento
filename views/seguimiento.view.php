    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post" class="form-inline">
        <fieldset >
            <div class="col-md-12">
                ...
                <div class="col-md-3 form-group">
                    <section id="contenedor" style="border: solid 1px black; height: 30px;"></section>
                </div>
                <div class="container col-md-2 form-group">
                    ...
                    <!-- Boton buscar -->
                    <!-- Modal -->
                    <?php include('views/modal.view.php')?>
                    <!--Fin Modal -->
                </div>
                ...
                <div class="col-md-3 form-group">
                    <section id="dedicacion" style="border: solid 1px black; height: 30px;"></section>
                </div>
            </div>
        </fieldset>
    </form>
