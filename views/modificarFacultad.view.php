...
<div class="nt-registroFacultad" >
    ...
    <legend>REGISTRO DE FACULTADES:</legend>
        ...
        <form action="actualizarFacultad.php?id=<?php echo $facultades['ID_FACULTAD'] ?>" method="POST" onsubmit="return validate();">
            ...
            <div class="form-group col-sm-6">
                ...
                <input class="form-control input-global" type="text" id="ubicacionFacultad" name="ubicacionFacultad" value="<?php echo $facultades['UBICACION_FACULTAD']; ?>" required>
            </div>
